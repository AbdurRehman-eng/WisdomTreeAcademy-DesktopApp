    ...
    return `
      <div class="report-page" style="page-break-after: always;">
        <div class="report-header" style="display: flex; align-items: center; justify-content: space-between;">
          <div style="display: flex; align-items: center;">
            ...
            <div>
              ...
              <div class="report-school-tag">Diagnostic Assessment Software v1.0.6 — Official Transcript</div>
            </div>
          </div>
        ...
        <div class="report-footer">
          <span>Generated by Wisdom Tree Academy Diagnostic Assessment Software v1.0.6</span>
