    ...
    <div className="desktop-app-frame">
      ...
      <div className="desktop-title-bar">
        ...
        <div className="title-bar-right">
          <button className="title-bar-btn" title="Minimize"><Minus size={12} /></button>
          <button className="title-bar-btn" title="Maximize"><Square size={10} /></button>
          <button className="title-bar-btn btn-close" title="Close"><X size={12} /></button>
        </div>
      </div>
