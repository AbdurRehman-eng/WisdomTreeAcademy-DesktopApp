        ...
        <>
          ...
          <div className="grid grid-cols-4">
            <div className="card metric-card">
              ...
              <div className="metric-details">
                ...
                <span className="metric-change positive">+4 this month</span>
              </div>
            </div>
            ...
            <div className="card metric-card">
              ...
              <div className="metric-details">
                ...
                <span className="metric-change">2 Administrators</span>
              </div>
            </div>
            ...
            <div className="card metric-card">
              ...
              <div className="metric-details">
                ...
                <span className="metric-change positive">140 / 148 present</span>
              </div>
            </div>
          ...
          <div className="dashboard-grid-main">
            ...
            <div className="card activity-feed-card">
              ...
              <button onClick={() => setScreen('reports')} className="view-all-logs-btn">
          ...
          <div className="grid grid-cols-3">
            ...
            <div className="card metric-card">
              ...
              <div className="metric-details">
                ...
                <span className="metric-value">18 tests</span>
                <span className="metric-change positive">100% evaluated</span>
              </div>
            </div>
                ...
                <div className="classes-grid">
                  <div className="class-status-card">
                    <div className="class-card-header">
                      ...
                      <span className="student-count-pill">15 Students</span>
                    </div>
                  ...
                  <div className="class-status-card">
                    <div className="class-card-header">
                      <span className="class-grade-tag">Grade 2</span>
                      <span className="student-count-pill">18 Students</span>
                    </div>
                    <p className="class-subject-list">English Grammar, Mathematics, General Science</p>
                    <div className="class-card-footer">
                      <button onClick={() => setScreen('assessment-setup')} className="class-action-btn primary-action">
                        <Play size={12} className="footer-btn-icon" />
                        Run Assessment
